      ...
      {isOpen && (
        <div className="fixed inset-0 z-modal flex items-start justify-center pt-[20vh] px-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg rounded-xl border border-border bg-surface-elevated shadow-2xl overflow-hidden"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="flex items-center gap-2 px-4 border-b border-border">
              ...
              />
              <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-[10px] font-mono text-muted bg-surface rounded border border-border">
                ESC
              </kbd>
            </div>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isSelected ? 'bg-primary-lighter text-primary' : 'text-foreground hover:bg-surface',
                          )}
