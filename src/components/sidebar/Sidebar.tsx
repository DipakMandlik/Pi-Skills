...
const NAV_ITEMS: NavItem[] = [
  ...
  { path: ROUTES.SKILLS, label: 'Skills', icon: Puzzle, permission: 'viewAllSkills' },
  { path: ROUTES.MODELS, label: 'Models', icon: Brain, permission: 'viewAllModels' },
  { path: ROUTES.MONITORING, label: 'Monitoring', icon: Activity, permission: 'viewAllMonitoring' },
  { path: ROUTES.GOVERNANCE, label: 'AI Governance', icon: Shield, permission: 'manageModels' },
];
