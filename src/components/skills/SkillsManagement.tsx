...
import { fetchSkills, fetchUsers, assignSkill, revokeSkill, fetchSkillRegistry, updateSkillState, type SkillRegistryItem, type UserItem } from '../../services/backendApi';
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <RoleGuard permission="revokeSkill">
                            <button
