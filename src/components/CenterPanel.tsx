...
export function CenterPanel({ projectButton }: { projectButton?: React.ReactNode } = {}) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full relative bg-bg-base">
      ...
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none mix-blend-overlay bg-[linear-gradient(135deg,_#000_0.5px,_transparent_0.5px),linear-gradient(45deg,_#000_0.5px,_transparent_0.5px)] bg-[size:8px_8px]" />
