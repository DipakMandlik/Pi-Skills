...
import cortexAgentBuilderMd from '../skills/cortex-agent-builder.skill.md?raw';
...
const SKILL_STYLES: Record<string, { bg: string; iconBg: string; text: string; border: string; hoverBg: string }> = {
  'Data Architect': { bg: 'bg-blue-50', iconBg: 'bg-blue-100', text: 'text-blue-600', border: 'border-blue-200', hoverBg: 'hover:bg-blue-50' },
  'Analytics Engineer': { bg: 'bg-emerald-50', iconBg: 'bg-emerald-100', text: 'text-emerald-600', border: 'border-emerald-200', hoverBg: 'hover:bg-emerald-50' },
  'ML Engineer': { bg: 'bg-purple-50', iconBg: 'bg-purple-100', text: 'text-purple-600', border: 'border-purple-200', hoverBg: 'hover:bg-purple-50' },
  'SQL Writer': { bg: 'bg-cyan-50', iconBg: 'bg-cyan-100', text: 'text-cyan-600', border: 'border-cyan-200', hoverBg: 'hover:bg-cyan-50' },
  'Query Optimizer': { bg: 'bg-amber-50', iconBg: 'bg-amber-100', text: 'text-amber-600', border: 'border-amber-200', hoverBg: 'hover:bg-amber-50' },
  'Data Explorer': { bg: 'bg-teal-50', iconBg: 'bg-teal-100', text: 'text-teal-600', border: 'border-teal-200', hoverBg: 'hover:bg-teal-50' },
  'Warehouse Monitor': { bg: 'bg-indigo-50', iconBg: 'bg-indigo-100', text: 'text-indigo-600', border: 'border-indigo-200', hoverBg: 'hover:bg-indigo-50' },
  'Metadata Inspector': { bg: 'bg-slate-50', iconBg: 'bg-slate-100', text: 'text-slate-600', border: 'border-slate-200', hoverBg: 'hover:bg-slate-50' },
  'Requirements Analyst': { bg: 'bg-orange-50', iconBg: 'bg-orange-100', text: 'text-orange-600', border: 'border-orange-200', hoverBg: 'hover:bg-orange-50' },
  'Data Contract Writer': { bg: 'bg-rose-50', iconBg: 'bg-rose-100', text: 'text-rose-600', border: 'border-rose-200', hoverBg: 'hover:bg-rose-50' },
  'Source System Surveyor': { bg: 'bg-sky-50', iconBg: 'bg-sky-100', text: 'text-sky-600', border: 'border-sky-200', hoverBg: 'hover:bg-sky-50' },
  'Metadata Explorer': { bg: 'bg-violet-50', iconBg: 'bg-violet-100', text: 'text-violet-600', border: 'border-violet-200', hoverBg: 'hover:bg-violet-50' },
  'Query Profiler': { bg: 'bg-pink-50', iconBg: 'bg-pink-100', text: 'text-pink-600', border: 'border-pink-200', hoverBg: 'hover:bg-pink-50' },
  'Lineage Analyst': { bg: 'bg-indigo-50', iconBg: 'bg-indigo-100', text: 'text-indigo-600', border: 'border-indigo-200', hoverBg: 'hover:bg-indigo-50' },
  'Data Quality Engineer': { bg: 'bg-green-50', iconBg: 'bg-green-100', text: 'text-green-600', border: 'border-green-200', hoverBg: 'hover:bg-green-50' },
  'Cost Optimization': { bg: 'bg-yellow-50', iconBg: 'bg-yellow-100', text: 'text-yellow-700', border: 'border-yellow-200', hoverBg: 'hover:bg-yellow-50' },
  'Cortex AI Functions': { bg: 'bg-fuchsia-50', iconBg: 'bg-fuchsia-100', text: 'text-fuchsia-600', border: 'border-fuchsia-200', hoverBg: 'hover:bg-fuchsia-50' },
  'Cortex Analyst Builder': { bg: 'bg-fuchsia-50', iconBg: 'bg-fuchsia-100', text: 'text-fuchsia-600', border: 'border-fuchsia-200', hoverBg: 'hover:bg-fuchsia-50' },
  'Semantic Layer Designer': { bg: 'bg-violet-50', iconBg: 'bg-violet-100', text: 'text-violet-600', border: 'border-violet-200', hoverBg: 'hover:bg-violet-50' },
  'dbt Developer': { bg: 'bg-orange-50', iconBg: 'bg-orange-100', text: 'text-orange-600', border: 'border-orange-200', hoverBg: 'hover:bg-orange-50' },
  'dbt Test Engineer': { bg: 'bg-orange-50', iconBg: 'bg-orange-100', text: 'text-orange-600', border: 'border-orange-200', hoverBg: 'hover:bg-orange-50' },
  'RBAC Manager': { bg: 'bg-red-50', iconBg: 'bg-red-100', text: 'text-red-600', border: 'border-red-200', hoverBg: 'hover:bg-red-50' },
  'Security Analyst': { bg: 'bg-red-50', iconBg: 'bg-red-100', text: 'text-red-600', border: 'border-red-200', hoverBg: 'hover:bg-red-50' },
  'Cortex Agent Builder': { bg: 'bg-fuchsia-50', iconBg: 'bg-fuchsia-100', text: 'text-fuchsia-600', border: 'border-fuchsia-200', hoverBg: 'hover:bg-fuchsia-50' },
  'Streamlit Developer': { bg: 'bg-cyan-50', iconBg: 'bg-cyan-100', text: 'text-cyan-600', border: 'border-cyan-200', hoverBg: 'hover:bg-cyan-50' },
  'Notebook Developer': { bg: 'bg-blue-50', iconBg: 'bg-blue-100', text: 'text-blue-600', border: 'border-blue-200', hoverBg: 'hover:bg-blue-50' },
  'Marketplace Advisor': { bg: 'bg-emerald-50', iconBg: 'bg-emerald-100', text: 'text-emerald-600', border: 'border-emerald-200', hoverBg: 'hover:bg-emerald-50' },
  'Task Planner': { bg: 'bg-purple-50', iconBg: 'bg-purple-100', text: 'text-purple-600', border: 'border-purple-200', hoverBg: 'hover:bg-purple-50' },
  'Workflow Orchestrator': { bg: 'bg-purple-50', iconBg: 'bg-purple-100', text: 'text-purple-600', border: 'border-purple-200', hoverBg: 'hover:bg-purple-50' },
  'Code Reviewer': { bg: 'bg-gray-50', iconBg: 'bg-gray-100', text: 'text-gray-600', border: 'border-gray-200', hoverBg: 'hover:bg-gray-50' },
  'Snowflake Docs Lookup': { bg: 'bg-sky-50', iconBg: 'bg-sky-100', text: 'text-sky-600', border: 'border-sky-200', hoverBg: 'hover:bg-sky-50' },
};
...
const buildDetailedSkillMarkdown = (skill: any) => {
  const skillMap: Record<string, string> = {
    ...
    'Cortex Agent Builder': cortexAgentBuilderMd,
...
export function LeftPanel() {
  const { skills, activeSkills, toggleSkill, addSkill, updateSkill, deleteSkill, projects, activeProjectId, setActiveProject, createProject } = useStore();
  ...
  return (
    <div className="w-[296px] h-full bg-panel border-r border-border flex flex-col shrink-0">
      {/* Logo - Gradient/3D Tech Style */}
      <div className="h-16 px-4 border-b border-border flex items-center shrink-0" style={{ background: 'linear-gradient(135deg, #eff6ff 0%, #ffffff 50%, #f0fdfa 100%)' }}>
        <div className="flex items-center gap-2.5">
          {/* π Symbol with gradient */}
          ...
          <div
            className="w-7 h-7 rounded-lg flex items-center justify-center font-bold text-sm text-white shadow-md"
            style={{
          ...
          {/* Brand name */}
          <div className="ml-1">
            <div className="text-sm font-semibold text-gray-800 leading-none">π-Optimized</div>
            <div className="text-[9px] text-gray-400 mt-0.5">Data Engineering Platform</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-3 py-3 border-b border-border">
          <div className="flex items-center justify-between mb-2.5">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Projects</span>
             <button onClick={() => setShowNewProject(!showNewProject)} className="w-6 h-6 flex items-center justify-center rounded-md hover:bg-gray-100 text-gray-400 hover:text-blue-500 transition-colors">
              ...
              <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="overflow-hidden mb-2">
                <div className="flex gap-1.5">
                  <input
                    ...
                    className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-1.5 text-sm outline-none focus:border-blue-400 focus:bg-white placeholder:text-gray-400 transition-colors"
                  />
                  <button onClick={handleCreateProject} disabled={!newProjectName.trim()} className="px-3 py-1.5 bg-blue-500 text-white text-sm font-medium rounded-lg hover:bg-blue-600 disabled:opacity-30 transition-colors shadow-sm">
                    Add
                  </button>
                </div>
              </motion.div>
          ...
          {projects.length > 0 ? (
            <div className="space-y-1">
              {projects.map(project => {
                ...
                return (
                  ...
                  >
                    <Icons.FolderKanban className={`w-4 h-4 shrink-0 ${isActive ? 'text-white/80' : 'text-gray-400'}`} />
            ...
            <button
              onClick={() => setShowNewProject(true)}
               className="w-full flex items-center justify-center gap-2 py-3 border-2 border-dashed border-gray-200 rounded-lg text-sm text-gray-400 hover:text-blue-500 hover:border-blue-300 transition-colors"
            >
              <Icons.Plus className="w-4 h-4" />
        ...
        <div className="px-3 py-3">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">AI Skills</span>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono text-gray-400 bg-gray-100 px-1.5 py-0.5 rounded">{activeSkills.length}/3 active</span>
                <button onClick={() => { setIsAdding(true); setEditName(''); setEditDesc(''); }} className="w-6 h-6 flex items-center justify-center rounded-md hover:bg-gray-100 text-gray-400 hover:text-blue-500 transition-colors">
                <Icons.Plus className="w-4 h-4" />
              </button>
            </div>
          </div>
          ...
          <AnimatePresence>
            {isAdding && (
              <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="bg-gray-50 p-3 rounded-xl border border-gray-200 mb-3 overflow-hidden">
                <input autoFocus value={editName} onChange={e => setEditName(e.target.value)} placeholder="Skill name" className="w-full bg-white border border-gray-200 rounded-lg px-2.5 py-2 text-sm mb-2 outline-none focus:border-blue-400" />
                <textarea value={editDesc} onChange={e => setEditDesc(e.target.value)} placeholder="Description" className="w-full bg-white border border-gray-200 rounded-lg px-2.5 py-2 text-xs mb-2 outline-none focus:border-blue-400 resize-none" rows={2} />
                <div className="flex justify-end gap-2">
                  <button onClick={() => setIsAdding(false)} className="text-xs text-gray-500 hover:text-gray-700 px-2 py-1">Cancel</button>
                  <button onClick={handleAddSave} className="text-xs bg-blue-500 text-white px-3 py-1 rounded-lg hover:bg-blue-600 font-medium">Save</button>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div className="space-y-2">
            {skills.map((skill) => {
              ...
              if (isEditing) {
                return (
                  <div key={skill.id} className="bg-gray-50 p-3 rounded-xl border border-gray-200">
                    <input autoFocus value={editName} onChange={e => setEditName(e.target.value)} className="w-full bg-white border border-gray-200 rounded-lg px-2.5 py-2 text-sm mb-2 outline-none focus:border-blue-400" />
                    <textarea value={editDesc} onChange={e => setEditDesc(e.target.value)} className="w-full bg-white border border-gray-200 rounded-lg px-2.5 py-2 text-xs mb-2 outline-none focus:border-blue-400 resize-none" rows={2} />
                    <div className="flex justify-end gap-2">
                      <button onClick={() => setEditingId(null)} className="text-xs text-gray-500 hover:text-gray-700 px-2 py-1">Cancel</button>
                      <button onClick={() => handleEditSave(skill.id)} className="text-xs bg-blue-500 text-white px-3 py-1 rounded-lg hover:bg-blue-600 font-medium">Save</button>
                    </div>
                  </div>
                );
              }
              ...
              return (
                <div
                  key={skill.id}
                  className={`rounded-xl border-2 transition-all cursor-pointer group ${
                    isActive
                ...
                >
                  ...
                  >
                    {/* Icon container */}
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${isActive ? style.iconBg : 'bg-gray-100'}`}>
                      <div className={isActive ? style.text : 'text-gray-400'}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className={`text-sm font-semibold truncate ${isActive ? style.text : 'text-gray-700'}`}>
                        {skill.name}
                      </div>
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      >
                        <Icons.ChevronRight className={`w-4 h-4 text-gray-400 transition-transform ${isExpanded ? 'rotate-90' : ''}`} />
                      </button>
                    </div>
                  </div>
                      ...
                      >
                        <div className="px-3 pb-3 pt-0">
                          <div className="border-t border-gray-200 pt-2 mt-1">
                            <p className="text-xs text-gray-500 leading-relaxed mb-2.5">{skill.description}</p>
                            <div className="flex items-center gap-1.5">
                                <button onClick={(e) => { e.stopPropagation(); handleDownloadSkill(skill); }} className="flex items-center gap-1 text-[11px] font-medium text-gray-500 hover:text-blue-500 px-2 py-1 rounded-md hover:bg-blue-50 transition-colors">
                                  <Icons.Download className="w-3 h-3" />
                                  Export
                                </button>
                                <button onClick={(e) => { e.stopPropagation(); startEdit(skill); }} className="flex items-center gap-1 text-[11px] font-medium text-gray-500 hover:text-blue-500 px-2 py-1 rounded-md hover:bg-blue-50 transition-colors">
                                <Icons.Edit2 className="w-3 h-3" />
                                Edit
                              </button>
                              <button onClick={(e) => { e.stopPropagation(); deleteSkill(skill.id); }} className="flex items-center gap-1 text-[11px] font-medium text-gray-500 hover:text-red-500 px-2 py-1 rounded-md hover:bg-red-50 transition-colors">
        ...
        <div className="px-3 py-3 border-t border-gray-100">
          <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider block mb-2.5">Quick Actions</span>
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <Icons.LayoutDashboard className="w-5 h-5 text-blue-500 group-hover:text-blue-600" />
              <span className="text-[11px] font-medium text-blue-600">Canvas</span>
            </button>
            <button
              onClick={() => {
                const store = useStore.getState();
              ...
              className="flex flex-col items-center gap-1.5 p-3 bg-emerald-50 hover:bg-emerald-100 rounded-xl transition-colors group"
            >
              <Icons.ListChecks className="w-5 h-5 text-emerald-500 group-hover:text-emerald-600" />
              <span className="text-[11px] font-medium text-emerald-600">Stories</span>
            </button>
            <button
              onClick={() => {
                const store = useStore.getState();
            ...
            >
              <Icons.GitBranch className="w-5 h-5 text-purple-500 group-hover:text-purple-600" />
              <span className="text-[11px] font-medium text-purple-600">Workflow</span>
            </button>
            <button
              onClick={() => {
              ...
              className="flex flex-col items-center gap-1.5 p-3 bg-amber-50 hover:bg-amber-100 rounded-xl transition-colors group"
            >
              <Icons.Activity className="w-5 h-5 text-amber-500 group-hover:text-amber-600" />
              <span className="text-[11px] font-medium text-amber-600">Monitor</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-2.5 border-t border-border shrink-0">
        <div className="flex items-center justify-between text-[10px] text-gray-400">
          <span className="font-mono">{skills.length} skills</span>
          <div className="flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
            <span className="font-mono">Snowflake</span>
          </div>
        </div>
      </div>
    </div>
