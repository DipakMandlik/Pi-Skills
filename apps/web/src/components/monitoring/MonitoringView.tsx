...
const MOCK_LOGS: LogEntry[] = [
  { id: 'l1', timestamp: '2026-03-25 14:32:18', user: 'Dipak Mandlik', action: 'CREATE_SKILL', target: 'Cortex Agent Builder', status: 'success', duration: '120ms' },
  { id: 'l2', timestamp: '2026-03-25 14:28:05', user: 'Data Analyst', action: 'RUN_QUERY', target: 'SELECT * FROM BANKING.BRONZE.ACCOUNT', status: 'success', duration: '340ms' },
  { id: 'l3', timestamp: '2026-03-25 14:25:42', user: 'Dipak Mandlik', action: 'ASSIGN_SKILL', target: 'SQL Writer → Data Analyst', status: 'success', duration: '85ms' },
  { id: 'l4', timestamp: '2026-03-25 14:20:11', user: 'Data Analyst', action: 'RUN_QUERY', target: 'SHOW TABLES IN BANKING.SILVER', status: 'success', duration: '210ms' },
  { id: 'l5', timestamp: '2026-03-25 14:15:33', user: 'Dipak Mandlik', action: 'REVOKE_ACCESS', target: 'ML Engineer from temp_user', status: 'success', duration: '95ms' },
  { id: 'l6', timestamp: '2026-03-25 14:10:00', user: 'Data Analyst', action: 'RUN_QUERY', target: 'SELECT COUNT(*) FROM BANKING.GOLD.FACT_TRANSACTIONS', status: 'error', duration: '15200ms' },
  ...
  { id: 'l9', timestamp: '2026-03-25 13:45:10', user: 'Data Analyst', action: 'CREATE_PROJECT', target: 'Customer 360', status: 'success', duration: '150ms' },
  { id: 'l10', timestamp: '2026-03-25 13:30:00', user: 'Data Analyst', action: 'RUN_QUERY', target: 'CREATE TABLE BANKING.SILVER.CUSTOMER_SUMMARY AS...', status: 'warning', duration: '4500ms' },
];
